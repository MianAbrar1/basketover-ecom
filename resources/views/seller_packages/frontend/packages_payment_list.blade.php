                        ...
                        <tr>
                            ...
                            <td>
                                @if($payment->approval == 1)
                                    <span class="approved-status">{{ translate('Approved') }}</span>
                                @else
                                    <span class="not-approved-status">{{ translate('Pending') }}</span>
                                @endif
                            </td>
                        </tr>
                    @endforeach
...
<style> .approved-status { color: green; font-weight: bold; } .not-approved-status { color: red; font-weight: bold; font-size: 13px; } </style>
@endsection